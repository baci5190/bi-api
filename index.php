<?php
define('ROOT', __DIR__);
$models = ['Indicadores','ResultadosOriginadores', 'NivelesTerritoriales','UnidadesMedida', 'TiposFuente','InstrumentosPlanificacion','DatosEstadisticos','IndicadorEstadistica', 'DatosLineaBase', 'DatosSerieHistorica', 'Departamentos', 'Municipios'];
